// ======================================================
// 🟢 SERVEUR — MiniGame Universe v4.1 (ESM Ready)
// ======================================================
// Compatible ES Modules pour Render
// ======================================================
...
// Fix ESM pour __dirname / __filename
...
// Route par code court — DOIT être avant /:id
    ...
    try {
        ...
        if (!/^[A-Z0-9]{6}$/.test(code)) {
            return res.status(400).json({
                error: 'Format de code invalide (6 caractères alphanumériques attendus).'
            });
        }
        ...
        if (!p) {
            return res.status(404).json({
                error: 'Code invalide ou expiré. Vérifiez le code ou demandez à votre host.'
            });
        }
